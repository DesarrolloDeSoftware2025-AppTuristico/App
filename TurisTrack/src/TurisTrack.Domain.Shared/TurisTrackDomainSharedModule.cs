...
public class TurisTrackDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TurisTrackDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TurisTrackResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/TurisTrack");

            options.DefaultResourceType = typeof(TurisTrackResource);
        ...
        {
            options.MapCodeNamespace("TurisTrack", typeof(TurisTrackResource));
        });
    }
}
