...
namespace TurisTrack.Migrations
{
    ...
    [Migration("20260103214119_Agregada Entidad de Dominio ApiMetrica")]
    partial class AgregadaEntidaddeDominioApiMetrica
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurisTrack.CalificacionesDestinos.CalificacionDestino", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppCalificacionesDestinos", (string)null);
                });

            modelBuilder.Entity("TurisTrack.DestinosTuristicos.DestinoFavorito", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UsuarioId", "DestinoId")
                        .IsUnique();

                    b.ToTable("AppDestinosFavoritos", (string)null);
                });

            modelBuilder.Entity("TurisTrack.DestinosTuristicos.DestinoTuristico", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("MetrosDeElevacion")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TurisTrack.ExperienciasDeViajes.ExperienciaDeViaje", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppExperienciasDeViajes", (string)null);
                });

            modelBuilder.Entity("TurisTrack.Metricas.ApiMetrica", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppApiMetricas", (string)null);
                });

            modelBuilder.Entity("TurisTrack.Notificaciones.Notificacion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TurisTrack.CalificacionesDestinos.CalificacionDestino", b =>
                {
                    b.HasOne("TurisTrack.DestinosTuristicos.DestinoTuristico", "DestinoTuristico")
                        .WithMany()
